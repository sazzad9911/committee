    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          >
            <Text style={[styles.lebel, { color: textColor }]}>
              {isBn ? "ফোন নাম্বার" : "Phone"}
            </Text>
            <Input
          ...
          <Button
            ...
            title={isBn ? "অ্যাকাউন্ট তৈরি করুন" : "Create an account"}
          />
          <View style={[mainStyle.flexBox, { justifyContent: "center" }]}>
            <Text
              ...
              style={[mainStyle.text14, { color: textColor }]}
            >
...
const icon = `<svg width="177" height="39" viewBox="0 0 177 39" fill="none" xmlns="http://www.w3.org/2000/svg">
