...
export default function AccountSettings({navigation}) {
  ...
  `;
  const right = `<svg width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M0.999703 1.03095L8.53058 8.49994L1.06159 16.0308" stroke="${colors.getTextColor()}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>  
  `;
