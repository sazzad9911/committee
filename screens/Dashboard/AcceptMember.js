...
সাধারণ সদস্য: 
এই বিকল্পটি সদস্যকে একটি সাধারণ কমিটির সদস্য হিসেবে নির্বাচিত করে৷

বিশেষ সদস্য: 
এই বিকল্পটি বেছে নিন যদি কমিটির মধ্যে সদস্যের একটি নির্দিষ্ট ভূমিকা থাকে, যেমন ম্যানেজার বা নেতা৷।
...
General Member: 
This option designates the member as a regular committee member.

Special Member: 
Choose this option if the member holds a specific role within the committee, such as manager or leader.
