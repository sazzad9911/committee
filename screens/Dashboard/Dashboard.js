...
const Header = ({ textColor, borderColor, headlines, onPress,state }) => {
  ...
  const fetchCount = async () => {
    try {
      const { data } = await get(`/notification/comity/get-unread-count/${comity.id}`,user.token);
