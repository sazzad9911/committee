...
export default function EditNotice({ navigation }) {
  const ref = useRef();
  ...
  const [subject,setSubject]=useState("আমি বাংলায় গান গাই ")
  const [details,setDetails]=useState("কক্সবাজার সদর হাসপাতাল মর্গের কাছে আজ সোমবার দুপুরে নিহত ১০ জনের লাশের জন্য অপেক্ষায় ছিলেন মহেশখালী ও চকরিয়ার ১০ কক্সবাজার সদর হাসপাতাল মর্গের কাছে আজ সোমবার দুপুরে নিহত ১০ জনের লাশের জন্য অপেক্ষায় ছিলেন মহেশখালী ও চকরিয়ার ১০ থেকেথেকেকক্সবাজার সদর হাসপাতাল মর্গের কাছে আজ সোমবার দুপুরে নিহত ১০ জনের লাশের জন্য অপেক্ষায় ছিলেন মহেশখালী ও চকরিয়ার ১০ থেকেকক্সবাজার সদর হাসপাতাল মর্গের কাছে আজ সোমবার দুপুরে নিহত ১০ জনের লাশের জন্য অপেক্ষায় ছিলেন মহেশখালী ও চকরিয়ার ১০ থেকে")
