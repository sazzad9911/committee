    ...
    <ScrollView style={{backgroundColor:backgroudColor}}>
      <LinearGradient
        ...
        colors={!isDark ? ac : dc}>
            ...
            <Input leftIcon={<SvgXml xml={search}/>} containerStyle={[{
                borderRadius:30,
                paddingHorizontal:15,
                minHeight:40,
                borderWidth:0
            },mainStyle.mt12]} placeholder={searchText}/>
        </LinearGradient>
        <View style={{
            flex:1,
            ...
            <Button style={{
                marginBottom:32
            }} LeftIcon={()=><SvgXml xml={plus}/>} title={createComityText}/>
        </View>
    </ScrollView>
  );
}
